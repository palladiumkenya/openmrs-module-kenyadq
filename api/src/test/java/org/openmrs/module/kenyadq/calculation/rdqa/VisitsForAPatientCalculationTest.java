...
@Ignore
public class VisitsForAPatientCalculationTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.kenyaemr.calculation.library.VisitsOnDayCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
	 */
	@Test
